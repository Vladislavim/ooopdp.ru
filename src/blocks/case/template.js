...
export function renderCaseCatalogue() {
 ...
 <header class="case-catalogue__intro"><div><nav aria-label="Хлебные крошки"><a href="../index.html">Главная</a><span aria-hidden="true">/</span><span aria-current="page">Проекты</span></nav><h1>Проекты и партнёры</h1><p>Задачи заказчиков, работа ПДП и проектные материалы.</p></div></header>
